...
pred_train_out_dir = 'pn_pred_circle_train_out_dir_tspcnn'
pred_valid_out_dir = 'pn_pred_circle_valid_out_dir_tspcnn'
pred_test_out_dir = 'pn_pred_circle_test_out_dir_tspcnn'
...
def main(net):
    ...
    train_dataset = DatasetReader(os.path.join(project_root, 'pannuke_packed_dataset'), 'fold_1', pt_radius_min=3, pt_radius_max=3, rescale=0.5)
    valid_dataset = DatasetReader(os.path.join(project_root, 'pannuke_packed_dataset'), 'fold_2', pt_radius_min=3, pt_radius_max=3, rescale=0.5)
    test_dataset = DatasetReader(os.path.join(project_root, 'pannuke_packed_dataset'), 'fold_3', pt_radius_min=3, pt_radius_max=3, rescale=0.5)
    ...
    for did, cur_dataset in enumerate([train_dataset, valid_dataset, test_dataset]):
        ...
        for pid in range(len(cur_dataset)):
            ...
            for batch_info, batch_patch in bpp_im.batch_get_im_patch_gen(batch_size*2):
