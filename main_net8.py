...
class MainNet(nn.Module):
    ...
    def __init__(self, in_dim=3, b1_out_dim=2, b2_out_dim=5):
        ...
        self.rvb1 = RevGroupBlock(64, 64, 1, act, RevBlockC, 16)

        self.b1_conv1 = ConvBnAct(64, 64, 3, 1, 1, act)
        self.b1_conv2 = nn.Conv2d(64, b1_out_dim, 1, 1, 0, bias=True)

        self._bm1.extend([self.conv1, self.rvb1, self.b1_conv1, self.b1_conv2])

        self.rvb2 = RevGroupBlock(64, 64, 1, act, RevBlockC, 16)

        self.b2_conv1 = ConvBnAct(64, 64, 1, 1, 0, act)
        self.b2_conv2 = nn.Conv2d(64, b2_out_dim, 1, 1, 0, bias=True)

        self._bm2.extend([self.rvb2, self.b2_conv1, self.b2_conv2])
...
if __name__ == '__main__':
    ...
    a = torch.zeros(200, 3, 64, 64).cuda(0)
    # a = torch.zeros(2, 512, 512, 3).cuda(0).permute(0, 3, 1, 2)
    net = MainNet(3, 2, 5).cuda(0)
